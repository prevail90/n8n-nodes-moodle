            ...
            try {
                ...
                if (resource === 'course') {
                    if (operation === 'create') {
                        ...
                        const shortname = this.getNodeParameter('shortname', i);
                        ...
                        responseData = await GenericFunctions_1.moodleApiRequest.call(this, 'POST', '', {}, courseParams);
                    }
                    if (operation === 'get') {
                ...
                if (resource === 'enrollment') {
                    if (operation === 'enroll') {
                        const userId = this.getNodeParameter('enrollUserId', i);
                        const courseId = this.getNodeParameter('enrollCourseId', i);
                ...
                if (resource === 'grade') {
                    if (operation === 'getUserGrades') {
                        const userId = this.getNodeParameter('gradeUserId', i);
                        responseData = await GenericFunctions_1.moodleApiRequest.call(this, 'POST', '', {}, {
                    ...
                    if (operation === 'getCourseGrades') {
                        const courseId = this.getNodeParameter('gradeCourseId', i);
                        responseData = await GenericFunctions_1.moodleApiRequest.call(this, 'POST', '', {}, {
                ...
                if (resource === 'message') {
                    if (operation === 'send') {
                        const toUserId = this.getNodeParameter('messageToUserId', i);
